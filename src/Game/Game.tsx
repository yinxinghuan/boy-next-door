...
const CLIPS: Clip[] = [
  { id: 'cup',        top: 80, left: 2,  width: 18, height: 18,
    labelKey: 'hotspot.cup',        video: 'clip_01_cup.mp4',
    endFrame: 'end_01_cup.png',        subtitleKey: 'sub.cup',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'ring',       top: 86, left: 22, width: 12, height: 12,
    labelKey: 'hotspot.ring',       video: 'clip_02_ring.mp4',
    endFrame: 'end_02_ring.png',       subtitleKey: 'sub.ring',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'glasses',    top: 82, left: 70, width: 22, height: 16,
    labelKey: 'hotspot.glasses',    video: 'clip_03_glasses.mp4',
    endFrame: 'end_03_glasses.png',    subtitleKey: 'sub.glasses',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'towel',      top: 82, left: 38, width: 18, height: 16,
    labelKey: 'hotspot.towel',      video: 'clip_04_towel.mp4',
    endFrame: 'end_04_towel.png',      subtitleKey: 'sub.towel',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'reflection', top: 8,  left: 38, width: 24, height: 18,
    labelKey: 'hotspot.reflection', video: 'clip_05_reflection.mp4',
    endFrame: 'end_05_reflection.png', subtitleKey: 'sub.reflection',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
];
